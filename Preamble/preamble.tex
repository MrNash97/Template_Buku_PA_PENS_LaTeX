...
\ifsetCustomMargin
  ...
  \pagestyle{plain}% To apply fancy header after geometry package is loaded
\fi
...
\usepackage{enumitem}
\setlist[enumerate,itemize,description]{noitemsep,topsep=0em,leftmargin=10mm}
...
{1pt} % sep
{
\uppercase} % before-code is code prerceding the title body.
[
%\vspace{-0.5ex}%
%\rule{\textwidth}{0.3pt}
...
[hang] % shape
{\bfseries} % format
{\filleft{\MakeUppercase{\thesection}}} % label
{5.5mm} % sep
{\uppercase}  
